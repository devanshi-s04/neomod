...
# digest2 scoring for v2 (proportional-cap) benchmark pure-S3M tracklets.
#
...
#
# Output: outputs/phase2_benchmark_s3m_v2/digest2_shards/d2_vdp_00000_r*.parquet
#
...
#       --outfile outputs/phase2_benchmark_s3m_v2/benchmark_comparison_s3m_v2.parquet \
#       --overwrite
...
mkdir -p logs outputs/phase2_benchmark_s3m_v2/digest2_shards
...
run_worker() {
    ...
    "$PY" "$WORKDIR/neomod/pipeline/sorcha_phase2.py" run-digest2 \
        --work-dir outputs/phase2_benchmark_s3m_v2 \
        --subsample-file outputs/phase2_benchmark_s3m_v2/no_subsample.parquet \
