...
#SBATCH --array=0-160%400
#SBATCH --chdir=/mmfs1/gscratch/dirac/ds2004/sorcha
#SBATCH --export=all
#SBATCH --output=logs/d2test/%x_%A_%a.out
#SBATCH --error=logs/d2test/%x_%A_%a.err
...
#
# Output: outputs/phase2_test_neomod3/digest2_shards/d2_vdp_00000_r*.parquet
#
# Combine after all tasks finish with:
#   python neomod/pipeline/sorcha_phase2.py combine \
#       --work-dir outputs/phase2_test_neomod3 \
#       --outfile outputs/phase2_test_neomod3/benchmark_comparison_s3m_v3.parquet \
#       --overwrite
...
mkdir -p logs outputs/phase2_test_neomod3/digest2_shards
...
run_worker() {
    ...
    "$PY" "$WORKDIR/neomod/pipeline/sorcha_phase2.py" run-digest2 \
        --work-dir outputs/phase2_test_neomod3 \
        --subsample-file outputs/phase2_test_neomod3/no_subsample.parquet \
