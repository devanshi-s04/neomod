...
\section{Methods: AKA everything you did over the past few months}
...
\subsection{How to: Pick an Population Model to be used by NEOOM (Solar System Model and Population Selection)}
\label{sec:popmodel}
...
\begin{figure*}[ht!]
\centering
\includegraphics[width=\textwidth]{helio_map_all_populations.pdf}
\caption{
...
\subsection{How to: compute apparent mag for a full population on the whole sky (and why it matters?) (Sky-Plane Cuts and Observation Geometry)}
...
\begin{figure*}[ht!]
\centering
\includegraphics[width=0.75\textwidth]{ecliptic_strip_MBA_NEO.pdf}
\caption{
...
\subsection{How to: clone your asteroids (Population Cloning)}
\label{sec:cloneast}
...
\subsection{How to: Convince ppl the Cloned population Model works! and characteristics of said model}
\label{sec:clonepop}
...
\begin{figure*}[ht!]
\centering
\includegraphics[width=0.85\textwidth]{comparison_M_distribution.pdf}
\caption{
...
\begin{figure*}[ht!]
\centering
\includegraphics[width=\textwidth]{trojan_L4L5_comparison.pdf}
\caption{
...
\begin{figure*}[ht!]
\centering
\includegraphics[width=0.75\textwidth]{ecliptic_strip_Trojans.pdf}
\caption{
...
\begin{figure*}[ht!]
\centering
\includegraphics[width=0.75\textwidth]{ecliptic_strip_TNO.pdf}
\caption{
...
\subsection{How to: Bayesian your nearest neighbours (Bayesian Density Estimation and Probability Maps)}
\label{sec:bayesian}
...
\begin{figure*}[ht!]
\centering
\includegraphics[width=\textwidth]{density_comparison_three_bins.pdf}
\caption{
...
\begin{figure*}[ht!]
\centering
\includegraphics[width=\textwidth]{probability_comparison_three_bins.pdf}
\caption{
...
\subsection{How to: get to an ROC curve? ( Classifier Evaluation and ROC Analysis)}
\label{sec:ROC}
